...
class Classifier(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_acc', self.accuracy(self.prob_activation(logits), y.long()), on_epoch=True, prog_bar=True)
        return loss
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('valid_loss'+name_extension, loss_soft, on_epoch=True, prog_bar=True, logger=False)
        acc_soft = self.accuracy(self.prob_activation(logits_soft), y.long())
        self.log('valid_acc'+name_extension, acc_soft, on_step=True, prog_bar=False)
        self.log('valid_acc'+name_extension, acc_soft, on_epoch=True, prog_bar=True, logger=False)
