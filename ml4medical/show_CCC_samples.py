...
data_folder='D:/Arbeit/med_data/CCC/CCC'
variant = 'CCC'
data_module = DataModule(root_folder=data_folder, data_variant=variant, train_batch_size=2,augmentations='auto',
...
show_transforms(data_module, 9, 3, variant=variant, case='train')
show_transforms(data_module, 9, 3, variant=variant, case='val')